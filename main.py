...
token_cp ='https://team-jnc-ba95987c225e.herokuapp.com/api?url={url}&token={raw_text4}'
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text4 == '/d':
        ...
        cptoken = "https://team-jnc-ba95987c225e.herokuapp.com/api?url={url}&token={raw_text4}"
        pwtoken = "pwtoken"
    else:
        cwtoken = raw_text4
        cptoken = raw_text4
